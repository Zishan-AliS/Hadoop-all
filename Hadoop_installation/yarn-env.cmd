...
@rem Java module system arguments for Java 17+ compatibility
set YARN_RESOURCEMANAGER_OPTS=--add-opens java.base/java.lang=ALL-UNNAMED --add-opens java.base/java.util=ALL-UNNAMED --add-opens java.base/java.lang.reflect=ALL-UNNAMED --add-opens java.base/java.util.concurrent=ALL-UNNAMED %YARN_RESOURCEMANAGER_OPTS%
set YARN_NODEMANAGER_OPTS=--add-opens java.base/java.lang=ALL-UNNAMED --add-opens java.base/java.util=ALL-UNNAMED --add-opens java.base/java.lang.reflect=ALL-UNNAMED --add-opens java.base/java.util.concurrent=ALL-UNNAMED %YARN_NODEMANAGER_OPTS%
@rem Java module system arguments for Java 17+ compatibility
set YARN_RESOURCEMANAGER_OPTS=--add-opens java.base/java.lang=ALL-UNNAMED --add-opens java.base/java.util=ALL-UNNAMED --add-opens java.base/java.lang.reflect=ALL-UNNAMED --add-opens java.base/java.util.concurrent=ALL-UNNAMED %YARN_RESOURCEMANAGER_OPTS%
set YARN_NODEMANAGER_OPTS=--add-opens java.base/java.lang=ALL-UNNAMED --add-opens java.base/java.util=ALL-UNNAMED --add-opens java.base/java.lang.reflect=ALL-UNNAMED --add-opens java.base/java.util.concurrent=ALL-UNNAMED %YARN_NODEMANAGER_OPTS%